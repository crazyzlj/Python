...
def GetYcRainSum(sTime, eTime, stcd, tDivide):
    ...
    def getXML(sTime, eTime, stcd, tDivide):
        try:
            ...
            conn.putheader("Cookie",
                           "td_cookie=18446744071625666010; CNZZDATA3906820=cnzz_eid%3D1560662269-1465952761-http%253A%252F%252Fyc.wswj.net%252F%26ntime%3D1465952761;ASP.NET_SessionId=nurmvus304xbfjofntol04jf")
            conn.endheaders()
