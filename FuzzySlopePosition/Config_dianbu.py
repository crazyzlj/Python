...
rootDir = r'E:\data\dianbu\AutoFuzSlpPos'                               ## workspace
...
TerrainAttrDict = {'RPI':r'E:\Anhui\FuzzySlpPosNew\preparedParams\rpi_skidmore.tif',\
                   'ProfC':r'E:\Anhui\FuzzySlpPosNew\preparedParams\profc.tif',\
                   'HorizC':r'E:\Anhui\FuzzySlpPosNew\preparedParams\horizc.tif',\
                   'Slope':r'E:\Anhui\FuzzySlpPosNew\preparedParams\slope.tif'}
...
if not AutoTypLocExtraction:
    RdgExtractionInfo = [['RPI',0.99,1.0],['ProfC',0.001,1.0],['Elev',950.0,2000.0],['Slope',0.0,1.0]]                                                    
    ShdExtractionInfo = [['RPI',0.9,0.95],['ProfC',0.001,1.0]]
    BksExtractionInfo = [['RPI',0.5,0.7],['ProfC',-0.0001,0.0001],['HorizC',-0.0001,0.0001],['Slope',6.0,90.0]]
    FtsExtractionInfo = [['RPI',0.2,0.3],['ProfC',-1.0,-0.001],['HorizC',0.0,1.0]]
    VlyExtractionInfo = [['RPI',0.0,0.1],['ProfC',-0.0005,0.0005],['Slope',0.0,1.0]]
...
if not AutoInfParams:
    RdgInferenceInfo = [['RPI','S',0.05,2,0.5,1,0,1],['ProfC','S',0.001,2,0.5,1,0,1],['Elev','S',20,2,0.5,1,0,1],['Slope','Z',1,0,1,3,2,0.5]]
    ShdInferenceInfo = [['RPI','B',0.1,2,0.5,0.1,2,0.5],['ProfC','S',0.001,2,0.5,1,0,1]]
    BksInferenceInfo = [['RPI','B',0.2,2,0.5,0.2,2,0.5],['ProfC','B',0.001,2,0.5,0.001,2,0.5],['HorizC','B',0.001,2,0.5,0.001,2,0.5],['Slope','S',3,2,0.5,1,0,1]]
    FtsInferenceInfo = [['RPI','B',0.1,2,0.5,0.1,2,0.5],['ProfC','Z',1,0,1,0.001,2,0.5],['HorizC','S',0.001,2,0.5,1,0,1]]
    VlyInferenceInfo = [['RPI','Z',1,0,1,0.1,2,0.5],['ProfC','B',0.001,2,0.5,0.001,2,0.5],['Slope','Z',1,0,1,3,2,0.5]]
else:
    RdgInferenceInfo = []
    ShdInferenceInfo = []
    BksInferenceInfo = []
