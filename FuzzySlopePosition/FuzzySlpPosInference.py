...
def FuzzySlpPosInference():
    SlpPosItems = [[RdgConfig,RdgTyp, RdgTag, RdgInferenceInfo,DistanceExponentForIDW, RdgInf],\
                    [ShdConfig,ShdTyp, ShdTag, ShdInferenceInfo,DistanceExponentForIDW, ShdInf],\
                    [BksConfig,BksTyp, BksTag, BksInferenceInfo,DistanceExponentForIDW, BksInf],\
                    [FtsConfig,FtsTyp,FtsTag, FtsInferenceInfo,DistanceExponentForIDW, FtsInf],\
                    [VlyConfig,VlyTyp, VlyTag, VlyInferenceInfo,DistanceExponentForIDW, VlyInf]]
