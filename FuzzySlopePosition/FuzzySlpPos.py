...
if __name__ == '__main__':
    ...
    AutoInfParams = True                                     ## when AutoInfParams is Ture, the program will generate inference parameters automatically.
    ...
    CalSPSI = Flase                                         ## calculate SPSI (Slope Position Sequence Index) or not, Be Caution, only when CalSecHardSlpPos is True, CalSPSI can be True
