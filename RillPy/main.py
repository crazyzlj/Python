...
@Revised   : 2015-1-28 Divided into seperate files for better version control
             2015-3-5  Use TIFF format as the default.
@author    : Liangjun Zhu
@summary   : Delineating and Extracting real rills from high resolution DEM.
...
if __name__ == '__main__':
    ## Input params
    DEMsrc = r'E:\MasterBNU\RillMorphology\test\testdem.tif'
    rootdir = r'E:\MasterBNU\RillMorphology\20150305'
    streamTHR = 0.01
    ...
    ## End File names definition

    ## Run algorithms
    DEMbuf,DEMfil,SlopeFile,SOSFile,AspectFile,FlowDirFile,FlowAccFile,CurvFile,CurvProfFile,CurvPlanFile = Util.UtilHydroFiles(DEMsrc, PreprocessDir)
