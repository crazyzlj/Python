...
def StreamReachAndWatershed(inlyr,inlyr1,inlyr2,inlyr3,shapefile,delineate,inputProc,ord,tree,coord,net,w):
    # Inputs
    ...
    if arcpy.Exists(shapefile):
        ...
        print "Input Outlets Shapefile as Network Nodes: "+shfl
